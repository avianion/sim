...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Yes | Loops API key for authentication |
| `email` | string | No | The contact email address \(used to identify the contact\) |
| `userId` | string | No | The contact userId \(used to identify the contact\) |
| `firstName` | string | No | The contact first name |
| `lastName` | string | No | The contact last name |
| `source` | string | No | Custom source value replacing the default "API" |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Yes | Loops API key for authentication |
| `email` | string | No | The contact email address to search for \(mutually exclusive with userId\) |
| `userId` | string | No | The contact userId to search for \(mutually exclusive with email\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Yes | Loops API key for authentication |
| `email` | string | No | The email address of the contact to delete |
| `userId` | string | No | The userId of the contact to delete |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Yes | Loops API key for authentication |
| `email` | string | No | The email address of the contact \(provide email or userId\) |
| `userId` | string | No | The userId of the contact \(provide email or userId\) |
